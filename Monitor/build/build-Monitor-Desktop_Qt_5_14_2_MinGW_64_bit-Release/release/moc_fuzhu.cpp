...
QT_MOC_LITERAL(3, 27, 13), // "startXPercent"
QT_MOC_LITERAL(4, 41, 12), // "widthPercent"
QT_MOC_LITERAL(5, 54, 13), // "startYPercent"
QT_MOC_LITERAL(6, 68, 13), // "heightPercent"
QT_MOC_LITERAL(7, 82, 20), // "captureScreenAndShow"
QT_MOC_LITERAL(8, 103, 20), // "onSliderValueChanged"
QT_MOC_LITERAL(9, 124, 22) // "onConfirmButtonClicked"

    },
    "fuzhu\0areaParamsConfirmed\0\0startXPercent\0"
    "widthPercent\0startYPercent\0heightPercent\0"
    "captureScreenAndShow\0onSliderValueChanged\0"
...
void fuzhu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->areaParamsConfirmed((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        case 1: _t->captureScreenAndShow(); break;
        case 2: _t->onSliderValueChanged(); break;
        ...
        {
            using _t = void (fuzhu::*)(int , int , int , int );
...
// SIGNAL 0
void fuzhu::areaParamsConfirmed(int _t1, int _t2, int _t3, int _t4)
{
